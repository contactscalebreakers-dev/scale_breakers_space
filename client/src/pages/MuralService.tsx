      ...
      <section className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl">
            Commission a personalized mural for your space. From concept to completion,
            we bring your artistic vision to life with professional execution and attention to detail.
          </p>
        </div>
      </section>
