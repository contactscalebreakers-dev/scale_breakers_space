          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li><Link href="/workshops"><a className="text-gray-400 hover:text-white transition">Workshops</a></Link></li>
                <li><Link href="/shop"><a className="text-gray-400 hover:text-white transition">Shop</a></Link></li>
                <li><Link href="/portfolio"><a className="text-gray-400 hover:text-white transition">Portfolio</a></Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-black text-lg mb-4 uppercase tracking-widest">Services</h4>
              <ul className="space-y-3 text-sm">
                <li><Link href="/mural-service"><a className="text-gray-400 hover:text-white transition">Mural Service</a></Link></li>
                <li><Link href="/mural-service"><a className="text-gray-400 hover:text-white transition">Custom Orders</a></Link></li>
              </ul>
            </div>
            <div>
